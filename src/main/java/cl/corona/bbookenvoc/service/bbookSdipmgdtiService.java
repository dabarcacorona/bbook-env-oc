...
import cl.corona.bbookenvoc.model.csvBbookSdipmgdti;
import cl.corona.bbookenvoc.repository.bbookSdipmgdtiRepository;
    ...
    public List<bbookSdipmgdti> writeToCsvDetailCsv(String archivo, String ruta, long idn) {
        ...
        try {
            ...
            for(bbookSdipmgdti row : ResultsToWriteIntoCsv) {
                ...
                LOG.info(String.valueOf(row.getPmgPackCost()));
